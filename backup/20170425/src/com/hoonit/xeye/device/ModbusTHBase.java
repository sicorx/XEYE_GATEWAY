...
abstract public class ModbusTHBase extends DeviceBase{
	...
	public ModbusTHBase(String deviceName, int protocol, int deviceType, String deviceOID, int unitID, String channel, String baudRate, List<Map<String, Object>> tagList){
		...
		if(networkErrorCnt >= networkErrorBasisCnt){
			...
			if(this.tagList.size() > 0){
				...
				for(Map<String, Object> tagMap : this.tagList){
					...
					if("2".equals((String)tagMap.get("OID"))){
						etcResultMap = new HashMap<String, String>();
						etcResultMap.put(deviceOID + ".2.0", val);
						break;
					}
				}
			}
