package com.hoonit.xeye.device.neid;
...
public class TSensor extends ModbusTHBase {
	
	public TSensor(String deviceName, int protocol, int deviceType, String deviceOID, int unitID, String channel, String baudRate, List<Map<String, Object>> tagList){
