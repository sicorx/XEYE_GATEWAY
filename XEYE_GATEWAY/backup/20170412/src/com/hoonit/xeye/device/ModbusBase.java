...
abstract public class ModbusBase extends DeviceBase{
	...
	public DeviceMIB getMIB(){
		...
		if("PMC".equals(this.deviceName)){
			...
			// Ch1 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".110.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch1 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".111.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch2 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".112.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch2 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".113.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch3 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".114.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch3 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".115.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch4 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".116.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch4 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".117.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch5 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".118.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch5 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".119.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch6 R/S/T 누적사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".120.0"), moAccess);
			oidList.add(octetStringOID);
			
			// Ch6 R/S/T 순간사용량 OID
			moAccess = MOAccessImpl.ACCESS_READ_ONLY;
			octetStringOID = new OctetStringOID(deviceMIB, new OID(deviceOID + ".121.0"), moAccess);
			oidList.add(octetStringOID);
