								...
								if("0".equals(connStatus)){
									...
									if(!"255".equals(hacPolicy) && !"3".equals(hacPolicy)){
										...
										if("0".equals(onOFF)){
											...
											// 냉난방
											SNMPAgentProxyManager.getInstance().setOIDValue(EnterpriseOIDManager.getEnterpriseOID() + "."+(i+60)+".5.0", String.valueOf(Integer.parseInt(hacPolicy)-1)); // 0:난방, 1:냉방
											// 설정온도
